...
/** @scope SC.LabelView.prototype */ {
  ...
  */
  ...
  render: function(context, firstTime) {
    ...
    // add icon if needed
    if (icon) {
      var url = (icon.indexOf('/')>=0) ? icon : '/static/sproutcore/foundation/en/current/blank.gif?1256536761';
...
; if ((typeof SC !== 'undefined') && SC && SC.scriptDidLoad) SC.scriptDidLoad('sproutcore/foundation');