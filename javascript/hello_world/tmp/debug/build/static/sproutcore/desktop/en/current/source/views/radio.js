  ...
  render: function(context, firstTime) {
    ...
    if (firstTime) {
      ...
      for(idx=0;idx<itemsLength;idx++) {
        ...
        icon = item[3];
        if (icon) {
          url = (icon.indexOf('/')>=0) ? icon : '/static/sproutcore/foundation/en/current/blank.gif?1256536761';
        ...
        var blankImage = '/static/sproutcore/foundation/en/current/blank.gif?1256536761';
...
});; if ((typeof SC !== 'undefined') && SC && SC.scriptDidLoad) SC.scriptDidLoad('sproutcore/desktop');