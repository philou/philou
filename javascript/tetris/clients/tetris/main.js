...
function main() {
  ...
  Tetris.server.preload(Tetris.FIXTURES) ;

  // TODO: refresh() any collections you have created to get their records.
  // ex: Tetris.contacts.refresh() ;
  ...
  // ex: Tetris.contactsController.set('content',Tetris.contacts);
    Tetris.gameController.set('game', Tetris.Game.create({ ticker: Tetris.Ticker.create({}), pieceFactory: Tetris.PieceFactory.create({})}));
} ;
